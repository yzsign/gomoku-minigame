...
app.getCheckinModalLayout = function() {
  var topPad = app.rpx(8);
  var headerBandH = app.rpx(80);
  var innerAfterHead = app.rpx(12);
  var calInnerPad = app.rpx(12);
  var monthNavH = app.rpx(42);
  var weekH = app.rpx(30);
  var cell = app.rpx(36);
  var rowGap = app.rpx(4);
  var gridH = 6 * cell + 5 * rowGap;
  var calCardH = calInnerPad * 2 + monthNavH + weekH + gridH;
  var gapCalPrimary = app.rpx(16);
  var primaryBtnH = app.rpx(52);
  var bottomPad = app.rpx(20);
  var w = Math.min(app.W - app.rpx(28), app.rpx(618));
  var innerH =
    topPad +
    headerBandH +
    innerAfterHead +
  ...
  var x0 = cx - w / 2;
  var y0 = cy - h / 2;
  var calLeft = x0 + app.rpx(20);
  var calW = w - app.rpx(40);
  var calTop = y0 + topPad + headerBandH + innerAfterHead;
  var monthNavY = calTop + calInnerPad;
  var navMidY = monthNavY + monthNavH * 0.5;
  var leftAx = calLeft + calInnerPad + app.rpx(36);
  var rightAx = calLeft + calW - calInnerPad - app.rpx(36);
  var hitR = app.rpx(26);
